pub fn rgb_to_ycbcr(r: i64, g: i64, b: i64) -> (i64, i64, i64) {
    ...
    let g = g as f64;
    let b = b as f64;
    let y = (0.0 + 0.299 * r + 0.587 * g + 0.114 * b) as i64;
    let cb = (128.0 - 0.169 * r - 0.331 * g + 0.500 * b) as i64;
    let cr = (128.0 + 0.500 * r - 0.419 * g - 0.081 * b) as i64;

    (y, cb, cr)
}

pub fn ycbcr_to_rgb(y: i64, cb: i64, cr: i64) -> (i64, i64, i64) {
    ...
    let cb = cb as f64;
    let cr = cr as f64;
    let r = (1.0 * y + 0.000 * (cb - 128.) + 1.400 * (cr - 128.)) as i64;
    let g = (1.0 * y - 0.343 * (cb - 128.) - 0.711 * (cr - 128.)) as i64;
    let b = (1.0 * y + 1.765 * (cb - 128.) + 0.000 * (cr - 128.)) as i64;
